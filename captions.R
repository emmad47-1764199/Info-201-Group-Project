# File containing a function to grab the correct caption based
# on the input and all the captions for each graph
get_text <- function(input) {
  ...
  texts <- c(
    ...
    person gets. It can be concluded that at 5 hours of sleep a night,
    65% of people make over $50,000 a year, but at 9 hours of sleep,
    about 85% of people make over $50,000 a year. Therefore, with an
    extra 4 hrs of sleep a night, you have a 25% higher chance of
    ...
    a night corresponding to lower severe stress symptoms. As
    sleep time decreases to 5 and increases to 9, severe
    stress levels rise. It can be concluded that with 5 hours of sleep
    a night, about 51% of people experience at least moderate stress
    symptoms, but at 8 hours, only about 37% of people experience
    these symptoms. Therefore, adding 3 hours of sleep decreases
    chances of at least moderate stress by 14%.",
