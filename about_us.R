about_us_page <- tabPanel(
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      p("Autumn 2019"),
      br(),
      p("View our technical report", 
        a("here", 
          href = "https://github.com/emmad47-1764199/Info-201-Group-Project/wiki/Technical-Report"))
    ),
    ...
    mainPanel(
      ...
      p(h6("Reflection: "), 
      "I hope to build my own application one day and building a shiny application 
      through trial and error as well as using lots of online sources, helped me 
      learn the process of good design. One of the most difficult aspects of our 
      sleep analysis process was being able to design the application the way we 
      wanted it to look without having a great amount of experience with Shiny. 
      This required using a lot of outside sources to find the proper functions to 
      use."),
      br(),
      ...
      p(h6("Reflection: "), 
      "As a research assistant I was really excited to take this course and develop 
      data science skills. Working on this project allowed me to think outside of 
      the box and outside of my comfort zone. Previously, I didn't know what career 
      path I wanted to follow after college but this project inspired me to look into 
      potential career fields within user experience research."),
      br(),
      ...
      p(h6("Bio: "), 
      "I used to consider sleeping a complete waste of time and thus am always
      ...
      from imagination. Recalling the process of building this wonderful project together 
      step by step, I not only felt the feeling of seeing dreams come true but also got 
      to know the power of group working. What’s more, the experience of overcoming so 
      many challenges we have never faced before with our own effort and help from each 
      other really makes me learn a lot more than just sitting in the lecture hall and 
      listening. After finishing this project, my ability of managing dataset and RStudio 
      has stepped much farther than I expected.")
    )
   )
 )
)
