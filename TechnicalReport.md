...
**Strengths**:  
First of all, the size of both datasets. Both datasets included over 1000 observations. Although, even larger datasets could have made our analysis even more precise, 1000 observations is large enough to allow us to draw conclusions from the data. Second, enough amount of variables. Both datasets had about 200 variables, so we were able to answer our research questions in depth as we had lots of data to explore. Third, the organization of creating these datasets. Both datasets came from collected data from questionnaire released by National Sleep Foundation, which established in 1990 and is the foremost publicly supported educational organization in the field of sleep. Therefore, the questionnaire they held must have been well designed and the data must have been well collected. What's more, since the goal of NSF is to increase public understanding of the importance of sleep to good health and productivity, which is also this study's goal, applying dataset from NSF just corresponds to this study's ultimate purpose.  
**Weakness**:  
First, there is no continuous data in both datasets, so it is impossible to compare two variables graphically through scatterplots. For example, a scatter plot could have been used to compare income to number of hours of sleep per night; if instead of being recorded as a range, income was recorded by exact amount. In both datasets, all of the questions asked to the participants required categorical responses. Second, there exist bias in the method of data collection of both datasets. The data was collected through phone interviews and certain groups of people may have been less willing to participate or be truthful than others. Further, only 17% of people contacted completed the survey, thus many people were excluded from the data. What's more, some regions have a much higher response rate to the survey than others. For example, only 19% of the Northeast completed the survey while 36% of the south completed the survey. This causes an exclusion of lots of the Northeast compared to the South. Both of these bias would caused the dataset be skewed and misled.

#### 3.2.1. Strength and Weakness employing the Envisioning Cards
**Strengths** -- **Non-targeted Use**:  
We choose the Envisioning Card "Non-targeted Use" to clarify one big strength of our datasets: size. Even though this project focuses mainly on the relationship between sleep and work performance and overall health, as both of datasets possess big enough size, we can always dig deeper and research more problem about sleeping. What's more, people who get to know these datasets from our project could apply them to their own research or even just take a look and then receive some information about sleeping's role in one's life. In conclusion, because these datasets have great participant size and large amount of variables, they can always be applied for unplanned or even better purposes in ways we do not intended, and affect people in ways we never realize.  
**Weakness** -- **Adaptation**:  
We choose the Envisioning Card "Adaptation" to clarify the weakness of our datasets. One big weakness of both datasets is the way they collecting data is biased. Therefore, even possessing big size, the situation these datasets revealed may still be biased and personal, and the result we could get from researching these data may be skewed and biased as well. Thus, people's adaptation of their lifestyles facilitated by our research may be led in unsuitable ways.
...
#### Description:
The data visualized aims to create images that portray the effects of sleep on health as well as performance in the workplace. The visuals in the part of 'Sleep and Health' aim to answer questions about how sleep is correlated to health as the visuals in the part of 'Sleep and Work' aim to answer questions about how sleep is correlated with work performance. In visualizing the data sets we had to be aware that all of our data is categorical due to multiple choice surveys. We decided to use the stacked bar chart to portray comparisons between the two categorical variables. Furthermore, these charts use a percentage based frequency rather than count on the y-axis. This makes the visual more readable and accurate despite different amounts of people reporting various hours of sleep. The color scales use a fade from light to dark which helps portray the variables from least to greatest.
